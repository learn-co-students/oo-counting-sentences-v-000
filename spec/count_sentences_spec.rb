puts describe String do
  ...
  puts  it "returns false if the string that you are calling this method on does NOT end in a period." do 
      expect("Hi, my name is Sophie".sentence?).to eq(false)
    end

  end

  puts describe "#question?" do
  ...
  puts  it "returns false if the string that you are calling this method on does NOT end in question mark." do
